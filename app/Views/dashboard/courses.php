        ...
        <section class="mt-10">
            ...
            <div class="fade-up delay-2 flex flex-col gap-4 mb-8 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex w-full max-w-2xl items-center gap-3 sm:w-auto flex-wrap">
                    ...
                    <button id="addCourseButton" type="button" class="inline-flex items-center gap-2 rounded-full bg-blue-500 px-4 py-2 text-sm font-semibold text-white transition hover:bg-blue-600">
                        + Course
                    </button>
                    <button id="addCategoryButton" type="button" class="inline-flex items-center gap-2 rounded-full bg-green-500 px-4 py-2 text-sm font-semibold text-white transition hover:bg-green-600">
                        + Category
                    </button>
            ...
            <div id="uploadModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-slate-900/60 p-4">
                <div class="w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-[2rem] bg-white shadow-2xl">
                    <div class="sticky top-0 z-10 flex items-center justify-between border-b border-slate-200 bg-white px-6 py-4 rounded-t-[2rem]">
                        <div>
                        ...
                        <button id="closeUploadModal" type="button" class="ml-4 flex-shrink-0 inline-flex items-center justify-center h-10 w-10 rounded-full bg-slate-100 text-slate-600 transition hover:bg-slate-200 focus:outline-none" aria-label="Close modal">✕</button>
                    </div>
                ...
                <div class="w-full max-w-lg rounded-[2rem] bg-white shadow-2xl">
                    ...
                    <form action="/home/storeCourse" class="space-y-4 px-6 py-6" method="post">
                        ...
                        <div class="flex flex-col gap-3 sm:flex-row sm:justify-end">
                            ...
                            <button type="submit" class="rounded-full bg-blue-500 px-5 py-3 text-sm font-semibold text-white transition hover:bg-blue-600">Tambah Course</button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="w-full max-w-lg rounded-[2rem] bg-white shadow-2xl">
                    ...
                    <form action="/home/storeCategory" class="space-y-4 px-6 py-6" method="post">
                        ...
                        <div class="flex flex-col gap-3 sm:flex-row sm:justify-end">
                            ...
                            <button type="submit" class="rounded-full bg-green-500 px-5 py-3 text-sm font-semibold text-white transition hover:bg-green-600">Tambah Kategori</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    (function () {
        ...
        if (cancelCourse) {
            cancelCourse.addEventListener('click', closeCourseModal);
        }
